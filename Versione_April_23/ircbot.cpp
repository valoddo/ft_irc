...
/*   Updated: 2026/04/23 17:03:01 by sel-khao         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    std::cout << "╔══════════════════════════════════════╗" << std::endl;
    std::cout << "║      🤖 BOT COMANDI DISPONIBILI      ║" << std::endl;
    std::cout << "╠══════════════════════════════════════╣" << std::endl;
    std::cout << "║ !help    - Mostra questi comandi     ║" << std::endl;
    std::cout << "║ !quote   - Frase motivazionale       ║" << std::endl;
    std::cout << "║ !time    - Orario attuale            ║" << std::endl;
    std::cout << "║ !hello   - Saluta il bot             ║" << std::endl;
    std::cout << "║ !frase   - Un'altra frase motivante  ║" << std::endl;
    std::cout << "╚══════════════════════════════════════╝" << std::endl;
}
